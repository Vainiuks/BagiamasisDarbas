            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    ...
                    <?php } else if ($userType == "Admin") { ?>
                        <a href="cart.php"><img src="includes/photos/cart.png" style="width:30px; height:25px; margin-left:-20px; margin-top:10px;"><sup class="supClass"><?php echo (string)$cartItemCount ?></sup></a>
                        <li class="nav-item dropdown">
